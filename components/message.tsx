        ...
        >
          ...
          {message.parts?.map((part, index) => {
            ...
            if (type === "tool-searchKnowledgeBase") {
              ...
              const errorText = isErrorText(outputText)
                ? outputText
                : undefined;
                ...
                <Tool defaultOpen={true} key={toolCallId}>
                  ...
                  <ToolContent>
                    ...
                    {state === "output-available" && (
                      <ToolOutput
                        errorText={errorText}
                        output={errorText ? undefined : outputText}
                      />
                    )}
                  </ToolContent>
                </Tool>
            ...
            if (type === "tool-searchExercise") {
              ...
              const renderOutput = () => {
                ...
                if (typeof part.output === "string") {
                  const errorText = isErrorText(part.output)
                    ? part.output
                    : undefined;
                  return (
                    <ToolOutput
